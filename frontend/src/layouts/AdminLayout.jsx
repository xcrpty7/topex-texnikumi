...
import {
  ...
  Image, Star, HelpCircle, Award, Settings, Play, ExternalLink, Globe,
} from 'lucide-react';
import { logout, selectUser } from '../features/auth/authSlice';
import { fetchDashboard } from '../features/admin/adminSlice';

const NAV = [
  { section: 'Bosh sahifa', items: [
    { to: '/admin',              label: 'Dashboard',       icon: LayoutDashboard, end: true },
  ]},
  { section: "Ma'lumotlar", items: [
    { to: '/admin/users',        label: 'Foydalanuvchilar', icon: Users },
    { to: '/admin/applications', label: 'Arizalar',          icon: ClipboardList, badge: true },
  ]},
  { section: 'Kontent', items: [
    { to: '/admin/courses',      label: 'Kurslar',           icon: BookOpen },
    { to: '/admin/blog',         label: 'Blog / Maqolalar',  icon: FileText },
    { to: '/admin/gallery',      label: 'Galereya',          icon: Image },
    { to: '/admin/testimonials', label: 'Sharhlar',          icon: Star },
    { to: '/admin/faq',          label: 'Savol-Javob',       icon: HelpCircle },
    { to: '/admin/scholarships', label: 'Grantlar',          icon: Award },
    { to: '/admin/home-videos',  label: 'Bosh sahifa videolari',    icon: Play },
    { to: '/admin/teachers',     label: "O'qituvchilar",     icon: Users },
    { to: '/admin/directions',   label: "Yo'nalishlar",      icon: BookOpen },
  ]},
  { section: 'Sozlamalar', items: [
    { to: '/admin/site-editor',  label: 'Sayt Muhariri',     icon: Globe },
    { to: '/admin/settings',     label: 'Sayt sozlamalari',  icon: Settings },
  ]},
];
        ...
        <div className="flex items-center justify-between px-5 py-5 flex-shrink-0" style={{ borderBottom: '1px solid #3a3b3c' }}>
          <Link to="/" className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] truncate" style={{ color: '#9ca0ad' }}>Admin Panel</p>
            </div>
          </Link>
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <ExternalLink size={13} /> Saytni ko'rish
            </Link>
          </div>
        </header>
